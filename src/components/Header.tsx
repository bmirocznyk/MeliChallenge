    ...
    <header className="bg-ml-yellow w-full">
      ...
      <div className="flex items-center justify-between w-full px-4 pb-2 mt-1">
        ...
        <div className="flex items-center text-xs text-gray-800 gap-1 flex-shrink-0">
          ...
          <span className="hidden sm:inline">Enviar a <b>Bruno</b> Jose Ingenieros 1756</span>
        ...
        <div className="flex items-center gap-2 md:gap-4 text-sm text-gray-800 flex-shrink-0">
          ...
          <button className="relative hover:text-ml-blue"><ShoppingCart className="w-4 h-4 md:w-5 md:h-5" /><span className="absolute -top-1 -right-1 md:-top-2 md:-right-2 bg-ml-orange text-white text-xs rounded-full w-3 h-3 md:w-4 md:h-4 flex items-center justify-center">1</span></button>
        </div>
      </div>
    </header>
  );
